...
export const ERROR_STATUS: Record<ErrorCodeValue, HttpStatus> = {
  ...
  [ErrorCode.APP_CHECK_REQUIRED]: HttpStatus.FORBIDDEN,
  [ErrorCode.AUDIT_CHAIN_BROKEN]: HttpStatus.INTERNAL_SERVER_ERROR,
...
export const CLIENT_MESSAGES: Record<ErrorCodeValue, string> = {
  ...
  [ErrorCode.APP_CHECK_REQUIRED]:
    'İstek doğrulanamadı. Lütfen uygulamanın güncel sürümünü kullanın.',
  [ErrorCode.AUDIT_CHAIN_BROKEN]: 'Beklenmeyen bir hata oluştu.',
