...
| Storage nesneleri (before/after)                 | K4    | Müşteri evinin fotoğrafı                          | **TODO(legal)** — bucket lifecycle                                                               | **Faz 13** (bucket lifecycle policy, R-83)       |
...
| BigQuery `raw_events`                            | K2    | Analitik kopya                                    | **TODO(legal)** — dataset policy                                                                 | **Faz 13** (dataset expiration, R-83)            |
