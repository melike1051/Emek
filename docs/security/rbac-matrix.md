...
| `POST /safety/sessions/:id/telemetry`                                | —                                           | ✅ oturumun sağlayıcısı    | —                                 | başkasının oturumu 404; oran sınırı 120/dk **fail-open** |
| `POST /safety/sessions/:id/panic`                                    | ✅ taraf                                    | ✅ taraf                   | —                                 | oran sınırı **yok** (Redis bağımsız); etkin panik tekil  |
| `GET /safety/operator/sessions`, `GET /safety/operator/sessions/:id` | —                                           | —                          | `ADMIN`, `SUPPORT`                | koordinat yok; değerlendirme + olay geçmişi              |
| `GET /safety/operator/sessions/:id/locations`                        | —                                           | —                          | `ADMIN`                           | ham iz; her okuma audit'li                               |
