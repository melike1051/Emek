...
| `APP_CHECK_REQUIRED`                | 403  | İstemci bütünlüğü doğrulanamadı (Firebase App Check — ADR-0022)     | 12 ✅ |
| `AUDIT_CHAIN_BROKEN`                | 500  | Denetim izi hash zinciri kopuk (iç hata; istemciye detay verilmez)  | 12 ✅ |
...
| `SAFETY_SESSION_NOT_ACTIVE`         | 409  | Oturum telemetri/panik kabul etmiyor (sağlayıcı henüz yola çıkmadı) | 8 ✅  |
| `SAFETY_SESSION_ALREADY_CLOSED`     | 409  | Oturum kapalı: telemetri/panik/operatör kararı kabul edilmez        | 8 ✅  |
| `SAFETY_INVALID_SESSION_TRANSITION` | 409  | Oturum bu duruma geçirilemez (ör. etkin acil durum varken kapatma)  | 8 ✅  |
